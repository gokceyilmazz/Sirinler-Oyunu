...
public class Gargamel extends Dusman {
    ...
    public Gargamel(int karakterID, String karakterAdi, String karakterTur) {
    ...
    public void setKarakterID(int karakterID) {
        super.setKarakterID(3); //To change body of generated methods, choose Tools | Templates.
    }
    ...
    public void setKarakterAd(String karakterAd) {
        super.setKarakterAd("gargamel"); //To change body of generated methods, choose Tools | Templates.
    }
